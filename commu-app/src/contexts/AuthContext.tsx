  ...
  useEffect(() => {
    const unsub = onAuthStateChanged(auth, async (firebaseUser) => {
      ...
      if (firebaseUser) {
        ...
        if (!p) {
          // Fallback: If user exists in Auth but document is missing in Firestore, create it.
          // This can happen if registration was interrupted by security rules or network error.
